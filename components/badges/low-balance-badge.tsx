...
export const LowBalanceBadge: React.FC<LowBalanceBadgeProps> = ({ row }) => {
    const prepaid_balances = row.original.connections?.prepaid_balances;
    const prepaid_info = row.original.connections?.prepaid_info;
