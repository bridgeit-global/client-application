...
export function PostpaidPaidFilterAction({
  filterBody,
  setFilterBody,
  handleApplyFilters,
  handleClearFilter
  ...
  return (
    ...
    >
      <div className="grid gap-3">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="due_date_start">Due Date Range</Label>
          <div className="flex space-x-2">
            <Input
              id="due_date_start"
              type="date"
...
export function PrepaidPaidFilterAction({
  filterBody,
  setFilterBody,
  handleApplyFilters,
  handleClearFilter
  ...
  return (
    ...
    >
      <div className="grid gap-3">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="recharge_date_start">
            Recharge Date Range
          </Label>
          <div className="flex space-x-2">
            <Input
