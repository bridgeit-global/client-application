      ...
      <div className="grid gap-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <Select
              onValueChange={(value) =>
                onChangeSelectHandle('connection_status', value)
              }
          ...
          <div className="space-y-1.5">
            ...
            <Select
              onValueChange={(value) =>
                onChangeSelectHandle('pay_type', value)
              }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="space-y-1.5">
            ...
            <Select
              onValueChange={(value) =>
                onChangeSelectHandle('bill_type', value)
              }
          ...
          <div className="space-y-1.5">
            ...
            <Select
              onValueChange={(value) =>
                onChangeSelectHandle('is_active', value)
              }
          ...
          <div className="space-y-1.5">
            ...
            <Select
              onValueChange={(value) =>
                onChangeSelectHandle('bill_status', value)
              }
        ...
        <div className="space-y-1.5">
          ...
          <Select
            onValueChange={(value) =>
              onChangeSelectHandle('bill_date_vs_fetch_date', value)
            }
        ...
        <div className="space-y-1.5">
          ...
          <Select
            onValueChange={(value) =>
              onChangeSelectHandle('bill_date_vs_due_date', value)
            }
        ...
        <div className="space-y-1.5">
          ...
          <Select
            onValueChange={(value) =>
              onChangeSelectHandle('is_overload', value)
            }
        ...
        <div className="space-y-1.5">
          ...
          <Select
            onValueChange={(value) =>
              onChangeSelectHandle('is_rebate_eligible', value)
            }
        ...
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChangeSelectHandle('paid_status', value)
            }
          >
            <SelectTrigger>
