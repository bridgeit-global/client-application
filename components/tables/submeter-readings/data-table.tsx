...
import { portalColumns, supportColumns } from './columns';
...
export function SubmeterReadingsDataTable({
  data,
  pageCount,
  totalCount,
  side,
  ...
  const table = useReactTable({
    data,
    columns: side === 'portal' ? portalColumns : supportColumns as any,
    ...
    <>
      <div className="flex flex-1 justify-between gap-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <ExportButton file_name="submeter_readings" />
          <TableColumns table={table} />
          <Button onClick={() => {
            if (side === "portal") {
              router.push("/portal/meter-reading")
            } else {
              router.push("/support/meter-reading/new")
            }
          }}>
