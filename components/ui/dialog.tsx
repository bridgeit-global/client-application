...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Use a higher z-index so dialogs (e.g. document viewers) appear above sticky headers/navbars
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Match overlay z-index so dialog content also appears above sticky headers/navbars
