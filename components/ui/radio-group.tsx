...
>(({ className, color = 'default', ...props }, ref) => {
    const colorClasses = {
        blue: "border-blue-500 text-blue-500 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500",
        green: "border-green-500 text-green-500 data-[state=checked]:bg-green-500 data-[state=checked]:border-green-500",
