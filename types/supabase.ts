    ...
    Tables: {
      ...
      biller_payment_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "biller_transactions_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      client_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "bill_payments_approved_by_fkey"
            columns: ["approved_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_payments_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      connections: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "connections_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      payment_gateway_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "payment_gateway_transactions_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pg_transactions_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      refund_payment_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "refund_transactions_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "refund_transactions_updated_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      registrations: {
        ...
        Relationships: [
          {
            foreignKeyName: "registration_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      sites: {
        ...
        Relationships: [
          {
            foreignKeyName: "site_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
      ...
      submeter_readings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "submeter_readings_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "submeter_readings_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "user_view"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_biller_stats: {
        ...
        Returns: {
          biller_id: string
          biller_stats: Json
          postpaid_connections: number
          prepaid_connections: number
        }[]
      }
      ...
      update_approved_bills: {
        Args:
          | { approver_email: string; bill_ids: string[] }
          | { bill_ids: string[] }
        Returns: undefined
      }
